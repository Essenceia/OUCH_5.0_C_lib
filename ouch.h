...
// fill the field of the ouch structure corresponding to the
// message type
int  fill_tv_ouch5(char msg_type, void* data, size_t data_len, tv_ouch5_s *ouch_s);

// print the currently valid ouch message type
void print_tv_ouch5_msg_type(const tv_ouch5_s * ouch_msg);

void print_tv_ouch5(const tv_ouch5_s* ouch_msg);
#endif // OUCH_H
